...
/*************************************************************************//**
 * A constructor for the DynamicRID object.
 */
CMOOSDynamicRID::CMOOSDynamicRID()
{   
  // Initialization
...
/*************************************************************************//**
 * A destructor for the DynamicRID object.
 */
CMOOSDynamicRID::~CMOOSDynamicRID()
{
...
/*************************************************************************//**
 * Overloaded function that is run once, when DynamicRID first connects
 ...
 */
bool CMOOSDynamicRID::OnConnectToServer()
{
  DoRegistrations();
 ...
 * @return  a boolean indicating success or failure
 */
bool CMOOSDynamicRID::OnNewMail(MOOSMSG_LIST &NewMail)
{
 ...
 * @return  a boolean indicating success or failure
 */
bool CMOOSDynamicRID::OnStartUp()
{
 ...
 */
void CMOOSDynamicRID::DoRegistrations()
{   
  // EXAMPLE:
